window.UserVoice = {
  ...
  account: {
    ...
    "subdomain_ssl_host": "stubhub-feedback.uservoice.com",
    "subdomain_site_host": "stubhub-feedback.uservoice.com",
    "subdomain_key": "stubhub-feedback",
    "subdomain_id": 254895,
    "client_key": "WFFuSp01RTP9g0jTO7oRA",
    "client_options": null,
    "smartvote_autoprompt_enabled": false,
    "satisfaction_autoprompt_enabled": false,
    "messages": {
      "Loading": "Loading"
    },
    ...
    "source_version": 1513882511
  },
  client_widgets: {},
  manifest: {
    "tab-left-dark": "/clients/widget2/tab-left-dark.png",
    "tab-left-dark-no-bullhorn": "/pkg/clients/widget2/tab-left-dark-no-bullhorn-b9a056c28655d222354ef7f6ae68c1a8.png",
    "tab-left-light": "/clients/widget2/tab-left-light.png",
    "tab-left-light-no-bullhorn": "/pkg/clients/widget2/tab-left-light-no-bullhorn-ac07b71a9046400d2e53eff8130d9101.png",
    "tab-right-dark": "/clients/widget2/tab-right-dark.png",
    "tab-right-dark-no-bullhorn": "/pkg/clients/widget2/tab-right-dark-no-bullhorn-f1a7a8ba764338840a5ea37dd05a3c4f.png",
    "tab-right-light": "/clients/widget2/tab-right-light.png",
    "tab-right-light-no-bullhorn": "/pkg/clients/widget2/tab-right-light-no-bullhorn-895e83ef59ef7640d46cc43702234b09.png",
    "tab-horizontal-dark": "/clients/widget2/tab-horizontal-dark.png",
    "tab-horizontal-dark-no-bullhorn": "/pkg/clients/widget2/tab-horizontal-dark-no-bullhorn-4a5913277bd3445572a530ba45e7e87e.png",
    "tab-horizontal-light": "/clients/widget2/tab-horizontal-light.png",
    "tab-horizontal-light-no-bullhorn": "/pkg/clients/widget2/tab-horizontal-light-no-bullhorn-19319b1343304a90f47eb2b21555dc49.png",
    "close": "/pkg/clients/widget2/close-d6b7b0dc72f036abfd8e5408bc092727.png",
    "pb": "/images/logos/UserVoice-logo-light.svg",
    "screenshot": "/pkg/clients/omnibox/screenshot-5b9171ba4e91bb16cccd54937cbba833.js"
  },
  kombucha_domain: 'https://by2.uservoice.com'
};
"undefined" != typeof UserVoice && UserVoice.showLightbox || ! function(t, e, o) {
  function i(t) {
    T("Error: " + t + " See https://www.uservoice.com/o/javascript-sdk for more help.")
  }
    ...
    if ("getComputedStyle" in t) {
      ...
      if (0 !== s) {
        var p = A.data(e, "transition-timer"),
          c = A.data(e, "transition-timeout-at"),
          d = +new Date + s;
        A.addClass(e, "uv-is-transitioning"), e.offsetWidth, (p === o || d > c) && (clearTimeout(p), A.data(e, "transition-timer", setTimeout(function() {
          A.removeClass(e, "uv-is-transitioning"), e.offsetWidth
        }, s)), A.data(e, "transition-timeout-at", d))
      }
    }
  }
  ...
  function c() {
    if (j) {
      var t = l();
      t.parentNode.removeChild(t), F ? e.head.appendChild(F) : a("user-scalable=1"), j = !1
    }
  }
  ...
  function b() {
    Y || (f("#uvTab,.uv-tray,.uv-icon,.uv-popover,.uv-bubble{display:none!important}", "print"), Y = !0)
  }

  function v() {
    X || (f(".uv-icon:hover{opacity:1}"), X = !0)
  }
  ...
  function k(t, e) {
    return e && ("support" === e.mode ? e.post_suggestion_enabled = !1 : "feedback" === e.mode && (e.contact_enabled = !1), delete e.mode, e.default_mode !== o && (e.classic_default_mode = e.default_mode), w(e)), O({
      mode: t
    }, e || {})
  }
  ...
  S.sanitizeValue = function(t, e) {
      ...
      var e, o, i, s, n, r, a, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
        p = "",
        c = 0;
      for (t = S.uTF8Encode(t); c < t.length;) e = t.charCodeAt(c++), o = t.charCodeAt(c++), i = t.charCodeAt(c++), s = e >> 2, n = (3 & e) << 4 | o >> 4, r = (15 & o) << 2 | i >> 6, a = 63 & i, isNaN(o) ? r = a = 64 : isNaN(i) && (a = 64), p = p + l.charAt(s) + l.charAt(n) + l.charAt(r) + l.charAt(a);
      return p
    }, S.extend = function(t) {
      for (var e = Array.prototype.slice.call(arguments, 1), o = e.length, i = 0; o > i; i++)
    ...
    }, S.deleteCookie = function(t, e) {
      var o = new Date;
      o.setFullYear(o.getFullYear() - 30), e = S.extend({
        expires: o
      }, e || {}), S.setCookie(t, "", e)
    }, S.trim = function(t) {
    ...
    function() {
      ...
      function i(t, e) {
        ...
        switch (u && "object" == typeof u && "function" == typeof u.toJSON && (u = u.toJSON(t)), "function" == typeof r && (u = r.call(e, t, u)), typeof u) {
          ...
          case "object":
            if (!u) return "null";
            if (s += n, d = [], "[object Array]" === Object.prototype.toString.apply(u)) {
              for (c = u.length, a = 0; c > a; a += 1) d[a] = i(a, u) || "null";
              return p = 0 === d.length ? "[]" : s ? "[\n" + s + d.join(",\n" + s) + "\n" + h + "]" : "[" + d.join(",") + "]", s = h, p
            }
            if (r && "object" == typeof r)
              for (c = r.length, a = 0; c > a; a += 1) "string" == typeof r[a] && (l = r[a], p = i(l, u), p && d.push(o(l) + (s ? ": " : ":") + p));
            else
              for (l in u) Object.prototype.hasOwnProperty.call(u, l) && (p = i(l, u), p && d.push(o(l) + (s ? ": " : ":") + p));
            return p = 0 === d.length ? "{}" : s ? "{\n" + s + d.join(",\n" + s) + "\n" + h + "}" : "{" + d.join(",") + "}", s = h, p
        }
      }
  ...
  var U = function(t, o) {
      function i(e, o) {
        var s = this;
        this.subdomain = e, this.config = S.extend({}, i.default_config, o || {}), this.kombuchaId = a++, this.sessionCallbackName = "__uvSessionData" + this.kombuchaId, t[this.sessionCallbackName] = function(t) {
          s.sync(t)
        }, this.tracks = [], this.identity = null, this.session = null, this.uvts = null, this.isReady = !1, this.needsIdentityFlush = !1, this.needsSessionFlush = !1, this.firedUvts = !1, this.firedSession = !1, this.syncedSession = !0, this.cookieable = null, this.initFromCookie(), t.__kombuchas.push(this)
      }
      ...
      t.__kombuchas = t.__kombuchas || [], i.prototype.initFromCookie = function() {
        ...
        this.log("Kombucha#updateSession: %O", t), this.needsSessionFlush = S.extend({}, this.needsSessionFlush || {}, this.session.set(t)), this.flush()
        ...
        o = this.config.v2 && "autoprompt" !== t.evt ? [this.config.domain, "/t2/", this.subdomain, "/", this.normalizeV2Channel(t.channel || this.config.channel)] : [this.config.domain, "/t/", this.subdomain, "/", l[t.channel || this.config.channel] || "_", "/", p[t.evt] || "_"], this.uvts && (o.push("/"), o.push(this.uvts)), o.push("/track.js?_=" + (new Date).getTime()), o.push("&s=" + (s ? "0" : "1")), o = o.join(""), this.needsIdentityFlush && (i.u = this.identity.toJSON(), this.needsIdentityFlush = !1), this.needsSessionFlush === Object(this.needsSessionFlush) && (i.u = S.extend({}, i.u || {}, this.needsSessionFlush), this.needsSessionFlush = !1), t.props && S.values(t.props).length > 0 && (i.e = t.props), this.log("Kombucha#sendTrack: %s, %O", o, i), i = S.values(i).length > 0 ? encodeURIComponent(S.base64Encode(JSON.stringify(i))) : null;
        var n, r, a;
        ...
        return null === this.cookieable && (S.setCookie("__uvt", "1", {
          domain: this.cookieDomain()
        }), this.cookieable = !!S.getCookie("__uvt"), S.deleteCookie("__uvt", {
          domain: this.cookieDomain()
        ...
        for (o in t) {
          ...
          if ((s.keys.hasOwnProperty(o) || i) && (this.props[o] = S.sanitizeValue(t[o], s.keys[o]), s.sizeLimits[o] && !S.isValidSize(this.props[o], s.sizeLimits[o]))) {
    ...
    z = S.base64Encode,
    O = S.extend,
    T = (S.values, S.setCookie, S.getCookie, S.lpad, S.trim, S.log),
  ...
  }, N.match(/IEMobile/i) ? N.ieMobile = !0 : N.match(/msie (\d+\.\d+);/i) ? (N.ie = !0, N.version = parseInt(RegExp.$1, 10), N["ie" + N.version] = !0, N.ieCompatibility = 7 === N.version && N.match(/Trident/i), N.ieQuirks = e.compatMode && "BackCompat" === e.compatMode) : N.match(/Trident.*rv:(\d+)/i) && (N.ie = !0, N.version = parseInt(RegExp.$1, 10), N["ie" + N.version] = !0), N.touch = "ontouchstart" in t, N.mobile = N.match(/Android.*Mobile|iPhone|IEMobile/i), N.tablet = !N.mobile && N.match(/Android|iOS/i), N.iOS = "ontouchstart" in t && N.match(/like Mac OS X/i);
  var F, I = function(t) {
    ...
    Y = !1,
    X = !1,
    L = ["https:" === e.location.protocol ? "https://" : "http://", "widget.uservoice.com"].join(""),
    D = {
    ...
    M = "    html.uvw-dialog-open object,    html.uvw-dialog-open iframe,    html.uvw-dialog-open embed {      visibility: hidden;    }    html.uvw-dialog-open iframe.uvw-dialog-iframe {      visibility: visible;    }    ",
    W = function() {
      function t(t) {
      ...
      return t.prototype.push = function(t) {
        ...
        }), t.src = this.options.imgSrc, b()
      }, t.prototype.createElement = function() {
        var t = this.el = h(d(this.template, this.options)),
        ...
        t = t === o ? !0 : t, t && r(this.el), A.addClass(this.el, "uv-is-hidden"), this.el.offsetWidth
      }, t.prototype.show = function() {
        r(this.el), A.removeClass(this.el, "uv-is-hidden"), this.el.offsetWidth
        ...
        var o = /([^\-]+)-([^\-]+)/.exec(e.trigger_position),
          ...
          l = [L, "/dcache", "/widget/feedback-tab.png?t=", encodeURIComponent(e.tab_label), "&c=", e.tab_inverted ? encodeURIComponent(e.trigger_background_color) : "ffffff", "&r=", encodeURIComponent(n), e.tab_inverted ? "&i=yes" : ""].join(""),
          p = e.trigger_position.replace(/middle-/, "").replace(/(bottom|top)-(right|left)/, "horizontal");
        p = ["tab-", p, e.tab_inverted ? "-light" : "-dark", "-no-bullhorn"].join(""), p = [L, UserVoice.manifest[p]].join(""), e.bgImage = p, e.imgSrc = l, e.tab_label = u(e.tab_label), r = D[r], a = D[a], (N.ie6 || N.ieQuirks) && (r += "position:absolute !important;", "top" === i ? r += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + (!this.offsetHeight && 0)) + 'px');" : "middle" === i ? r += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + ((((document.documentElement.clientHeight || document.body.clientHeight) + (!this.offsetHeight && 0)) / 2) >> 0)) + 'px');" : "bottom" === i && (r += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + (document.documentElement.clientHeight || document.body.clientHeight) - this.offsetHeight) + 'px');")), e.tabStyle = d(r, {
          color: e.trigger_background_color,
          bgImage: e.bgImage
        }), e.linkStyle = a, "top" === i ? this.edge = "top" : "bottom" === i ? this.edge = "bottom" : "left" === s ? this.edge = "left" : "right" === s && (this.edge = "right"), this.rotation = n, this.options = e
      }, t
    }(),
    P = function() {
      function i() {}
      return i.template = '      <div class="uv-popover-content">        <div class="uv-popover-iframe-container"></div>        <div class="uv-popover-loading"><div class="uv-popover-loading-text">' + I("Loading") + '&#8230;</div></div>        <!-- shadow for ie8 -->        <div class="uv-popover-content-shadow"></div>      </div>    ', i.prototype.show = function(t) {
        ...
        this.position(), r(this.el), A.removeClass(this.el, "uv-is-hidden"), this.el.offsetWidth, this.createIframe()
      }, i.prototype.preload = function() {
        this.el || this.render(), this.createIframe(!0)
      }, i.prototype.animateOut = function() {
        r(this.el), A.addClass(this.el, "uv-is-hidden")
        ...
        var o = A(this.el, "uv-popover-iframe-container"),
          ...
          s = this;
        (!this.iframe || this.needsReload) && (this.iframe && (o.removeChild(this.iframe.el), this.needsReload = !1), e && (A.removeClass(this.el, "uv-is-hidden"), this.el.style.left = "-10000px", this.preloading = !0), this.iframe = new K("popover", this.options.widgetType, O({
          height: "100%"
        }, UserVoice.globalOptions, this.options)), this.iframe.render(), A.addClass(this.iframe.el, "uv-popover-iframe"), o.appendChild(this.iframe.el), N.ie8 && A.addClass(this.el, "uv-ie8"), A.on(t, "resize", function() {
          s.visible() && s.calculatePosition()
        }), i && i.parentNode && (this.iframe.loaded || N.ie && N.version < 10 ? i.parentNode.removeChild(i) : A.one(this.iframe.el, "load", function(t) {
        ...
        o.innerHTML = this.template, o.setAttribute("data-html2canvas-ignore", !0), this.options.width && !N.mobile && (A(o, "uv-popover-content").style.width = this.options.width), this.options.height && !N.mobile && (A(o, "uv-popover-content").style.height = this.options.height), A.addClass(this.el, "uv-popover uv-is-hidden"), t.appendChild(o)
      }, i
    }(),
    R = function() {
      function o(t) {
        this.template = P.template, this.options = t, b()
      }
      return o.prototype = O({}, P.prototype), o.prototype.render = function() {
        this.createElement(e.body)
      }, o.prototype.show = function() {
        var e, o, i;
        N.mobile && p(), P.prototype.show.apply(this, arguments), N.match(/iPhone OS 7/) && (e = this, (i = function() {
          e.visible() && (o !== y().height ? (t.scrollBy(0), o = y().height, setTimeout(i, 80)) : setTimeout(i, 800))
        })())
      }, o.prototype.hide = function() {
        P.prototype.hide.apply(this, arguments), N.mobile && (c(), this.needsReload = !0)
        ...
        var e = this.options.position.match(/^(top|bottom)-(left|right)$/) ? this.options.position : "bottom-right",
          o = /(\w+)-(\w+)/.exec(e);
        if (this.el.style.zIndex = 100003, N.mobile) {
          ...
          var r = 20;
          this.el.style.left = "", this.el.style[o[1]] = r + "px", this.el.style[o[2]] = r + "px"
        }
    ...
    B = function() {
      function t(t, e) {
        this.template = P.template + '<div class="uv-popover-tail"></div>', this.options = t, this.trigger = e, b()
      }
      return t.prototype = O({}, P.prototype), t.prototype.render = function() {
        ...
        P.prototype.paneOpened.apply(this, arguments), this.setTailColor(e.backgroundColor)
        ...
        var t = this.target,
          ...
          n = 100;
        return "fixed" !== s && (o.top -= e.body.scrollTop, o.left -= e.body.scrollLeft), o.top < n ? "bottom" : o.top + i.height + n > y().height ? "top" : o.left < n ? "right" : o.left + i.width + n > y().width ? "left" : o.top > o.top + i.height - y().height ? "bottom" : "top"
    ...
    J = function() {
      function t(t) {
        ...
        this.options = O({}, e, t), this.options.trigger_position.match(/^(bottom|top)-(left|right)$/) || (this.options.trigger_position = e.trigger_position), this.widgets = [], N.touch || v(), b()
      }
      return t.icon_images = {
        ...
        this.el || this.createElement(), this.el.innerHTML = t.icon_images[o], N.ie8 || (this.options.trigger_color && (A(this.el, "path", "uv-bubble-foreground").style.fill = this.options.trigger_color), this.options.trigger_background_color && (A(this.el, "path", "uv-bubble-background").style.fill = this.options.trigger_background_color)), A.on(this.el, "click", function() {
          e.visibleWidget ? e.visibleWidget.hide() : e.widget.show()
        }), N.touch || N.ie && !(N.ie && N.version > 9) || A.one(e.el, "mousemove", function() {
          e.widget.preload()
        })
      }, t.prototype.createElement = function() {
        var t = this.el = e.createElement("div");
        t.setAttribute("data-html2canvas-ignore", !0), A.addClass(this.el, "uv-icon uv-" + this.options.trigger_position), N.ie8 && A.addClass(this.el, "uv-ie8"), e.body.appendChild(this.el)
    ...
    H = function() {
      ...
      return t.prototype.render = function() {
        ...
        }, A.on(this.el, "click", this.clickHandler), N.touch || N.ie && !(N.ie && N.version > 9) || A.one(this.el, "mousemove", function() {
    ...
    K = function() {
      ...
      return i.all = [], i.prototype.setLocation = function() {
        ...
        return l && "object" == typeof l && (e.strings = z(JSON.stringify(l))), e.smartvote_status_ids && (e.status_ids = e.smartvote_status_ids, delete e.smartvote_status_ids), e.smartvote_category_ids && (e.category_ids = e.smartvote_category_ids, delete e.smartvote_category_ids), this.options.menu_enabled !== o && (e.menu = this.options.menu_enabled), this.options.smartvote_enabled !== o && (e.smartvote = this.options.smartvote_enabled), this.options.satisfaction_enabled !== o && (e.satisfaction = this.options.satisfaction_enabled), this.options.post_suggestion_enabled !== o && (e.feedback_enabled = this.options.post_suggestion_enabled), "classic_widget" === this.options.type && (this.options.classic_default_mode !== o && (e.default_mode = this.options.classic_default_mode), e.mode = this.options.contact_enabled ? this.options.post_suggestion_enabled ? "full" : "support" : "feedback"), e.referrer = t.location.href, g(e, function(t) {
          try {
    ...
    $ = function() {
      function t(t, e) {
        var o = A.dimensions(t).height,
          ...
          s = Q.processModeOptions(O(i, UserVoice.globalOptions, e)),
          n = new K("inline", s.widgetType, s),
    ...
    q = function() {
      function o(t, e) {
        this.iframe = new K("lightbox", t.widgetType, O({
      ...
      return o.prototype.toggle = function() {
        ...
        if (this.overlay || (f(M), this.overlay = h(d(this.template, this))), this.iframe.poke("opened"), !this.dialog || this.dialog.getAttribute("data-widget-key") !== this.id) {
          ...
          var t = this;
          A.on(e.getElementById(this.dialog_close_id), "click", function(e) {
            return t.hide()
          })
        }
      }, o
    ...
    Q = function() {
      ...
      return i.setUvts = function(t) {
        i.uvts = t, K.sendUserData()
      }, i.setEmail = function(t) {
        i.email = t, K.sendUserData()
      }, i.setName = function(t) {
        i.name = t, K.sendUserData()
      }, i.setSSO = function(t) {
        i.sso = t, K.sendUserData()
      }, i.addExternalUserId = function(t) {
        i.external_user_ids || (i.external_user_ids = []), i.external_user_ids.push(t), K.sendUserData()
        ...
        return o.send = function(o, s, n, r) {
          ...
          t[a] = r;
          var l = [];
          for (var p in s) l.push(p + "=" + encodeURIComponent(s[p]));
          l.push(n + "=" + a);
          var c = e.createElement("script");
          c.src = o + "?" + l.join("&"), c.type = "application/javascript", c.async = !0, c.defer = !0;
          var d = e.getElementsByTagName("script")[0];
          d.parentNode.insertBefore(c, d)
        }, o
      }(), i.autoprompt = function() {
        if (N.mobile) return void(this.pendingAutoprompt = !1);
        if (this.session === !1 || this.systemTrigger && this.systemTrigger.el === o) return void(this.pendingAutoprompt = !0);
        var t = this.tracker.dumpSession(),
          e = this.shouldShowSatisfactionPrompt(t),
          s = this.shouldShowSmartVotePrompt(t);
        if (e || s) {
          if (this.syncedSession === !1) return this.pendingAutoprompt = !0, void this.tracker.syncSession();
          var n = {};
          if (this.tracker.identity)
            for (var r = ["id", "account_id", "email"], a = 0; a < r.length; a++) {
              var l = this.tracker.identity.get(r[a]);
              l && (n[r[a]] = l)
            }
          var p = this;
          if (e) {
            var c = function(t) {
              t.last_satisfaction_autoprompt_at && p.tracker.session.set({
                last_satisfaction_autoprompt_at: 1e3 * t.last_satisfaction_autoprompt_at
              }), t.satisfaction && (i.recordAutoprompt("satisfaction2"), i.pushSystemWidget({
                mode: "satisfaction"
              }), i.showAutoprompt({
                mode: "satisfaction"
              }), p.tracker.track("autoprompt", {}, "satisfaction_widget"))
            };
            this.jsonp.send("https://by2.uservoice.com/autoprompt/" + UserVoice.account.subdomain_id + "/satisfaction", n, "c", c);
          }
          if (s) {
            var d = function(t) {
              t.last_smartvote_autoprompt_at && p.tracker.session.set({
                last_smartvote_autoprompt_at: 1e3 * t.last_smartvote_autoprompt_at
              }), t.smartvote && (i.recordAutoprompt("smartvote2"), i.showAutoprompt({
                mode: "smartvote"
              }), p.tracker.track("autoprompt", {}, "smartvote_widget"))
            };
            this.jsonp.send("https://by2.uservoice.com/autoprompt/" + UserVoice.account.subdomain_id + "/smartvote", n, "c", d)
          }
        }
        ...
        for (var n = 0; n < o.length; n++) {
          var r = o[n];
          t(r, "data-uv-inline", this.renderInline), t(r, "data-uv-embed", this.renderInline), t(r, "data-uv-lightbox", this.linkToLightbox), t(r, "data-uv-show", this.linkToPopover), t(r, "data-uv-trigger", this.linkToPopover)
        }
      }, i.renderInline = function(t, e, o) {
        "classic_widget" === e ? new $(t, k(e, o)) : new $(t, O({
          mode: e,
          contact_enabled: !0,
          post_suggestion_enabled: !0,
          smartvote_enabled: !0,
        ...
        return t.contact_enabled && !UserVoice.account.has_ticketing_system && (t.contact_enabled = !1), t.feedback_enabled && !UserVoice.account.has_feedback_system && (t.feedback_enabled = !1), t.smartvote_enabled && !UserVoice.account.has_smartvote && (t.smartvote_enabled = !1), t.satisfaction_enabled && !UserVoice.account.has_satisfaction && (t.satisfaction_enabled = !1), t.mode = t.mode || (t.contact_enabled ? "contact" : t.smartvote_enabled ? "smartvote" : "post_suggestion"), t.mode.match(/instant/) && (t.mode = "contact"), "post_idea" === t.mode && (t.mode = "post_suggestion"), t.widgetType = "classic_widget" === t.mode ? t.mode : "omnibox", UserVoice.account.has_ticketing_system || "contact" !== t.mode || (t.mode = "post_suggestion"), UserVoice.account.has_satisfaction || "satisfaction" !== t.mode || (t.mode = "post_suggestion"), UserVoice.account.has_smartvote || "smartvote" !== t.mode || (t.mode = "post_suggestion"), UserVoice.account.has_feedback_system || "post_suggestion" !== t.mode || (t.mode = "contact"), t
        ...
        return e && e.autoprompt && (i.autopromptOptions = O({
          target: t
        ...
        var e = O({
          ...
          s = "icon" === o ? new J(e) : new W(e),
          n = i.createWidget(O({
            trigger_method: "pin"
          }, t), s);
        if (!(N.ie && N.version < 8 && "icon" === o)) return s.push(n), s.render(), s
        ...
        var o = {
          ...
          s = i.processModeOptions(O(o, UserVoice.globalOptions, t));
        return N.mobile && (s.mobile = !0), "lightbox" === s.target || "classic_widget" === s.mode ? new q(s, e) : s.target === !1 || "self" === s.target && !e ? (s.position = s.position || "bottom-right", new R(s, e)) : (s.position && s.position.match(/^(automatic|top|bottom|left|right)$/) || (s.position = "automatic"), N.mobile ? new R(s, e) : new B(s, e))
        ...
        var o = i.tracker.getIdentity() || {},
          s = {
            "audit[prompt_type]": t,
            "audit[uvts]": i.uvts,
            "audit[session_data]": JSON.stringify(O(i.tracker.dumpSession(), {
              source_version: UserVoice.account.source_version
            })),
        ...
        r.type = "application/javascript", r.async = !0, r.defer = !0, r.src = ("https:" === e.location.protocol ? "https://" : "http://") + UserVoice.account.subdomain_ssl_host + "/clients/widgets/omnibox/autoprompts/create.js?" + g(s), n.parentNode.insertBefore(r, n)
        ...
        captureScreenshot: function(o, i, s) {
          ("http://widget.uservoice.com" === s || "https://widget.uservoice.com" === s) && (t.html2canvas_onload_options = {
            ...
            t.type = "text/javascript", t.async = !0, t.src = "//assets.uvcdn.com" + UserVoice.manifest.screenshot + "?" + o;
  ...
  UserVoice.globalOptions = {}, UserVoice._getWidgetEnv = function() {
    return Q
    ...
    if ("object" == typeof t) UserVoice.globalOptions = m(UserVoice.globalOptions, t), t.sso && Q.setSSO(t.sso);
    else {
      var o = {};
    ...
    var t = arguments[0],
      e = arguments[1],
      s = arguments[2];
    return ("string" != typeof t || "#" === t[0]) && (e = arguments[0], s = arguments[1], t = null), e === o ? i("please specify where to embed it.") : void Q.renderInline(A.element(e), t, s)
  }, UserVoice.addTrigger = function(t, e) {
    if (t && t.nodeName || "string" == typeof t) {
      if (N.ie && N.version < 8) return;
      Q.createCustomTrigger(A.element(t), e)
    } else e = t || {}, Q.systemTrigger && Q.systemTrigger.remove(), Q.systemTrigger = Q.createSystemTrigger(w(e))
  }, UserVoice.show = function(t) {
    "string" == typeof arguments[0] && (t = O({
      mode: arguments[0]
    }, arguments[1] || {})), Q.showWidget(O({
      trigger_method: "show"
    }, t || {}))
    ...
    Q.tracker.identify(t, e), t && (t.email && Q.setEmail(t.email), t.name && Q.setName(t.name))
  }, UserVoice.setIdentity = function(t) {
    t && (t.email && Q.setEmail(t.email), t.name && Q.setName(t.name))
    ...
    e && (e.trigger_position = e.position, e.position = "automatic"), UserVoice.addTrigger(O({
      mode: t,
      trigger_style: "icon"
    }, e || {}))
  }, UserVoice.showTab = function(t, e) {
    UserVoice.addTrigger(O({
      trigger_style: "tab"
    }, k(t, e)))
  }, Q.includeCss();
